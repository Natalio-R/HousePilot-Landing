...
import HousePilot from "../assets/Logo.png";
        ...
        <div class="md:flex md:justify-between">
          <div class="mb-6 md:mb-0">
            <a href="/" class="flex items-center">
              <img src={HousePilot} class="h-8 mr-3" alt="House Pilot Logo" />
          ...
          <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
            <div>
              <h2 class="mb-6 text-sm font-semibold uppercase">Short Links</h2>
